...
public interface IQueueService
{
    ...
    Task SendMessageAsync<T>(T message, CancellationToken cancellationToken) where T : BaseMessage, new();
}
...
public class QueueService : IQueueService
{
    ...
    public QueueService(IBus bus, IConfiguration configuration, IMapper mapper, IPublishEndpoint publishEndpoint)
    {
